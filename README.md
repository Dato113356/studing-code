...
Welcome to my data analysis learning project! Here, I will share my learning process in the field of data analysis, the tools I used, and the projects I have completed.
Table of Contents
...
Here are some data analysis projects I have completed:

    Project 1: Wine Quality Analysis
    ...
    Project 2: Clustering
        ...
        Libraries Used: Python, Pandas, Seaborn, scikit-learn, SciPy
        View Project
    ...
    Project 4: Tree Algorithms
        Description: Practicing tree structure, comparing classification and regression, CART and C4.5, regression trees, recap: Ensemble, bagging, and random forest.
        Libraries Used: Python, Pandas, Seaborn, scikit-learn, statsmodels
        View Project

Tools Used

During my learning process, I utilized the following tools:

    Programming Language: Python
    Data Processing: Pandas, NumPy, statsmodels, SciPy
